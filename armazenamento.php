...
$sql = "SELECT nome, link, preco, imagem_url FROM tb_produto 
        WHERE categoria = 'hardware' AND tipo = 'armazenamento' 
    ...
    <main>
        ...
        <div class="botoes-paginacao">
            <?php if ($paginaAtual > 1): ?>
                <a href="?pagina=<?php echo $paginaAtual - 1; ?>" class="paginacao-botao paginacao-anterior">Anterior</a>
            <?php endif; ?>
            ...
            <?php if ($paginaAtual < $totalPaginas): ?>
                <a href="?pagina=<?php echo $paginaAtual + 1; ?>" class="paginacao-botao paginacao-proximo">Próximo</a>
            <?php endif; ?>
        </div>
    </main>
